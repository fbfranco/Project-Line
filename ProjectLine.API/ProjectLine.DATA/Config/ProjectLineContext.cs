...
namespace ProjectLine.DATA.Config
{
    public class ProjectLineContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Phase>().Property(x => x.DemoName).HasMaxLength(250);
            ...
            #region Model PermissionsRoles
            modelBuilder.Entity<PermissionRole>().HasKey(x => new { x.RoleID, x.PermissionID });
            #endregion
        }
    }
}
